...
{
    public abstract class GovermentSecuritySystemAppWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static GovermentSecuritySystemAppWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(GovermentSecuritySystemAppWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<GovermentSecuritySystemAppDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<GovermentSecuritySystemAppDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<GovermentSecuritySystemAppDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<GovermentSecuritySystemAppDbContext, Task<T>> func)
        {
            T result;
