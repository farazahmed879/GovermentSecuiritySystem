...
namespace GovermentSecuritySystemApp.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = GovermentSecuritySystemAppConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(GovermentSecuritySystemAppDbContext context)
        {
            _context = context;
        }
